            ...
            <ScreenCmpt style={styles.container}
                ...
                <Swiper navigation={this.props.navigation}>
                    <View style={styles.slide}>
                        ...
                        <Text style={styles.text}>Kukuza makes it easy for you to top up your cUSD wallet. Both Add or withdraw cUSD</Text>
                    </View>
                    <View style={styles.slide}>
                        <Image source={SLIDER_IMAGE_002} style={styles.image} />
                        <Text style={styles.header}>Community</Text>
                        <Text style={styles.text}>Kukuza is a community, owned by its members.</Text>
                    </View>
                    <View style={styles.slide}>
